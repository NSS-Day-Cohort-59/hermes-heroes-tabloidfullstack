...
insert into UserProfile (Id, DisplayName, FirstName, LastName, Email, CreateDateTime, ImageLocation, UserTypeId, FirebaseUserId) values (1, 'Foo', 'Foo', 'Barington', 'test1@testing.comx', '2020-04-23', 'https://robohash.org/numquamutut.png?size=150x150&set=set1', 1, 'b9B4WHUURRTKoGn0dZyC4VKA8G73');
insert into UserProfile (Id, DisplayName, FirstName, LastName, Email, CreateDateTime, ImageLocation, UserTypeId, FirebaseUserId) values (2, 'rdo1', 'Red', 'Do', 'test2@testing.comx', '2020-04-20', 'https://robohash.org/nisiautemet.png?size=150x150&set=set1', 2, 'vPeN3d2aB9RRtKyZ3o1wBES2cnl2');
